...
#### Day02 - [Элементы языка](./Day01-15/02. Элементы языка.md)
...
#### Day04 - [Структура цикла](./Day01-15/04. Cyclic Structure.md)
...
#### Day05 - [Логика программы построения](./Day01-15/05. Программа построения logic.md)
...
#### Day06  [Использование функций и модулей](./Day01-15/06. Использование functions and modules.md)
...
#### Day07 - [Строка и общая структура данных](./Day01-15/07. Строка и общая структура данных.md)
...
#### Day08 - [Базовое объектно-ориентированное программирование](./Day01-15/ 08. Basic Object-Oriented Programming.md)
...
#### Day10 - [Разработка графического интерфейса пользователя и игр](./Day01-15/10. Графический интерфейс пользователя и Game Development.md)
...
#### Day11- [Файл и исключение](./Day01-15/11. File and Exception.md)
...
#### Day12- [Строка и регулярное выражение](./Day01-15/ 12. String and Regular Expression.md)
...
#### Day13- [Процессы и потоки](./Day01-15/ 13. Процессы и потоки.md)
...
#### Day14- [Введение в сетевое программирование и разработку сетевых приложений](./Day01-15/ 14. Introduction to Network Programming and Network Application Development.md)
...
#### Day15- [Обработка изображений и документов](./Day01-15/ 15. Image and office document processing.md)
...
### Day16 ~ Day20 - [язык Python продвинутый](./Day16-20/16-20.Python language advanced.md)
...
### Day21 ~ 30 - [Введение в веб-интерфейс](./Day21-30/21-30.Web front-end overview.md)
...
- [Реляционная база данных MySQL](./Day36-40/36-38. Реляционная база данных MySQL.md)
...
- [Запись в базе данных NoSQL](./Day36-40/39-40.NoSQL database entry.md)
  - Обзор NoSQL
  - Redis обзор
  - Обзор Монго
...
#### Day41 - [Быстрый запуск Django](./Day41-55/41.Django Quick Start.md)
...
#### Day43- [Статический ресурс и запрос Ajax](./Day41-55/43. Статический ресурс и Ajax request.md)

- Загрузить статические ресурсы
- Обзор Ajax
- Используйте Ajax для голосования

#### Day44- [Cookie и сеанс](./Day41-55/44.Cookie и Session.md)
...
#### Day45- [Отчеты и журналы](./Day41-55/45. Make reports.md)
...
#### Day46- [Панель инструментов журнала и отладки](./Day41-55/46. Log and Debug Toolbar.md)

- Журнал конфигурации
- Настроить Django-Debug-Toolbar
- Оптимизировать код ORM

#### Day47- [Приложение промежуточного слоя](./Day41-55/47. Middleware Application.md)

- Что такое промежуточное ПО
- Middleware встроено в платформу Django
- Пользовательское промежуточное ПО и сценарии его применения

#### Day48- [Введение в раздельную разработку Front-end и Back-end](./Day41-55/48. Introduction to Front-end и Back-end Separated Development.md)

- Возврат данных в формате JSON
- Рендеринг страницы с помощью Vue.js

#### Day49- [Введение в архитектуру RESTful и DRF](./Day41-55/49. Введение в архитектуру RESTful и DRF.md)

#### Day50- [RESTful архитектура и расширенный DRF](./Day41-55/50.RESTful архитектура и DRF advanced.md)

#### Day51- [Использовать кеш](./Day41-55/51. Использовать cache.md)
...
#### Day52- [Доступ к трехсторонней платформе](./Day41-55/52. Доступ к трехсторонней платформе platform.md)

- Файл загрузки формы управления и предварительный просмотр файла изображения
- Как сервер обрабатывает загруженные файлы

#### Day53- [Асинхронные задачи и задачи по времени](./Day41-55/53. Асинхронные задачи и задачи по времени.md)
...
### Day56 ~ 60- [Разработка интерфейса данных с помощью FastAPI](./Day56-60/56-60. Разработка интерфейса данных с помощью FastAPI.md)
...
#### Day61- [Веб-сканеры и связанные инструменты](./Day61-65/61. Веб-сканеры и связанные с ними tools.md)
...
#### Day62- [Сбор и анализ данных](./Day61-65/62. Data Collection and Analysis.md)
...
#### Day63- [Storage Data](./Day61-65/63. Storage Data.md)

- Как хранить массивные данные
- Выполнить кеширование данных

#### Day64- [одновременная загрузка](./Day61-65/64. Concurrent Download.md)
...
#### Day65- [Анализ динамического контента](./Day61-65/65. Анализ динамического контента.md)
...
#### Day66- [Обзор анализа данных](./Day66-70/66. Обзор анализа данных.md)

#### Day67- [Приложение NumPy](./Day66-70/67.NumPy Application.md)

#### Day68- [Приложение Pandas](./Day66-70/68.Pandas Application.md)

#### Day69- [Визуализация данных](./Day66-70/69. Data Visualization.md)

#### Day70- [Фактическая битва проекта анализа данных](./Day66-70/70. Data Analysis Project Actual Combat.md)

### Day71 ~ 85 - [Машинное обучение и глубокое обучение](./Day71-85)

#### Day71- [Machine Learning Foundation](./Day71-85/71. Machine Learning Foundation.md)

#### Day72- [классификация ближайшего соседа](./Day71-85/72.k классификация ближайшего соседа.md)

#### Day73- [Дерево решений](./Day71-85/73. Decision Tree.md)

#### Day74- [Байесовская классификация](./Day71-85/74.Bayesian Classification.md)

#### Day75- [Support Vector Machine](./Day71-85/75. Support Vector Machine.md)

#### Day76- [K-означает кластеризацию](./Day71-85/76.K-означает clustering.md)

#### Day77- [Регрессионный анализ](./Day71-85/77. Regression Analysis.md)

#### Day78- [Введение в глубокое обучение](./Day71-85/78. Introduction to Deep Learning.md)

#### Day79- [Обзор Tensorflow](./Day71-85/79.Tensorflow Overview.md)

#### Day80- [Фактический бой Tensorflow](./Day71-85/79.Tensorflow Actual Combat.md)

#### Day81- [Kaggle project combat](./Day71-85/81.Kaggle project combat.md)

#### Day82- [Tianchi Big Data Project Actual Combat](./Day71-85/82. Tianchi Big Data Project Actual Combat.md)

#### Day83- [Recommended System Actual Combat-1](./Day71-85/83. Recommended System Actual Combat-1.md)

#### Day84- [Recommended System Actual Combat-2](./Day71-85/84. Recommended System Actual Combat-2.md)

#### Day85- [Рекомендация системы Actual Combat-3](./Day71-85/85. Рекомендуемая система Actual Combat-3.md)

### Day86 ~ 90- [Обзор анализа больших данных](./Day86-90)

#### Day86- [Обзор больших данных](./Day86-90/86. Big Data Overview.md)

#### Day87- [Hive query](./Day86-90/87.Hive query.md)

#### Day88- [PySpark и автономная обработка данных](./Day86-90/87.PySpark и offline data processing.md)

#### Day89- [Flink и обработка потоковых данных](./Day86-90/89.Flink and streaming data processing.md)

#### Day90- [Фактическая борьба проекта анализа больших данных](./Day86-90/90. Проект анализа больших данных Actual Combat.md)

### Day91 ~ 100- [Разработка командного проекта](./Day91-100)

#### День 91: [Проблемы и решения для разработки командного проекта](./Day91-100/91. Проблемы и решения для командного проекта Development.md)
...
#### День 92: [Подробный контейнер Docker](./Day91-100/92.Detailed Docker container.md)
...
#### День 93: [Оптимизация производительности MySQL](./Day91-100/93.MySQL performance optimisation.md)

#### День 94: [Дизайн интерфейса сетевого API](./Day91-100/94. Network API Interface Design.md)

#### День 95: [Разработка коммерческих проектов с помощью Django](./Day91-100/95. Используйте Django для разработки коммерческих проектов projects.md)
...
#### День 98: [Развертывание проекта и настройка производительности](./Day91-100/98. Развертывание проекта и настройка производительности tuning.md)
...
#### День 99: [Общественные вопросы в интервью](./Day91-100/99. Общественные вопросы в Interview.md)

#### День 100: [Запись вопроса на собеседовании Python](./Day91-100/100.Python Interview Question Record.md)

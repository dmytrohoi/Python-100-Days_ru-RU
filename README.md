...
<details>
  <summary>Прогресс перевода и адаптации</summary>
  
  | Урок | Статус | Примечание |
  | ---- | ------ | ---------- |
  | README | ███████████░░ 90% | Дополнительно вычитать примечания к дням. Исправить ссылки на дни. |
  | Day1 | ██████████░░░ 78% | Дополнительно вычитать информацию, заменить рисунки, добавить про VSCode и отформатировать красиво. |
  | Day2 | ██████████░░░ 78% | Дополнительно вычитать информацию, заменить рисунки, заменить форматирование строки с `'' % ()` на `''.format()`и отформатировать сам документ красиво. |
...
##### Общие вопросы в развитии проекта
